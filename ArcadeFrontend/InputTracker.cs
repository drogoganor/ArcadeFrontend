...
{
    private static readonly HashSet<Key> _currentlyPressedKeys = [];
    private static readonly HashSet<Key> _newKeysThisFrame = [];

    private static readonly HashSet<MouseButton> _currentlyPressedMouseButtons = [];
    private static readonly HashSet<MouseButton> _newMouseButtonsThisFrame = [];
