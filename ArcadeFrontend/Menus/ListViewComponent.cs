...
public class ListViewComponent : IRenderable
{
    ...
    public void Draw(float deltaSeconds)
    {
        ...
        var games = gamesFileProvider.Data.Games.Where(x => x.System == SystemType.Mame);
            ...
            ImGuiWindowFlags.NoFocusOnAppearing))
        {
            ...
            if (ImGui.BeginListBox("", listSize))
            {
                ...
                {
                    if (ImGui.Selectable(listItem.Name, index == state.CurrentGameIndex))
                    {
                        gameCommandsProvider.SetGameIndex(index);
                    }
